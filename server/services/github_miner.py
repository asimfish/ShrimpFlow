...
MENTOR_CATALOG: dict[str, dict] = {
    ...
    "torvalds": {
        ...
        "philosophy": "代码不需要注释，行为是最好的文档。错误的想法比错误的代码更危险。",
        "focus": ["kernel", "C", "os"],
        "domain": "系统工程",
    },
    "antirez": {
        ...
        "repo": "redis/redis",
        "repos": ["redis/redis", "antirez/kilo"],
        "github_login": "antirez",
        "tagline": "Redis / Kilo 作者 — 1000行代码能做的事，不用1001行",
        "philosophy": "好的软件是减法的艺术。每一行代码都是负担，只有必要的负担才值得承担。",
        "focus": ["redis", "C", "database", "minimalism"],
        "domain": "数据库/系统",
    },
    "mitchellh": {
        "name": "Mitchell Hashimoto",
        "repo": "hashicorp/vagrant",
        "repos": ["hashicorp/vagrant", "hashicorp/terraform"],
        "github_login": "mitchellh",
        "tagline": "HashiCorp 创始人 — 基础设施即代码，长期主义",
        "philosophy": "基础设施应该像代码一样可读、可测试、可版本控制。复杂性是最大的敌人。",
    ...
    "gvanrossum": {
        ...
        "philosophy": "代码被读的次数远多于被写的次数。为读者写代码，不为编译器写代码。",
    ...
    "dhh": {
        ...
        "philosophy": "框架的工作是让正确的事情变得简单，而不是让所有事情都变得可能。",
    ...
    "yyx990803": {
        "name": "Evan You",
        "repo": "vuejs/core",
        "repos": ["vuejs/core", "vitejs/vite"],
        "github_login": "yyx990803",
        "tagline": "Vue / Vite 作者 — 渐进式设计，开发体验与性能并重",
        "philosophy": "工具应该是渐进的：初学者能快速上手，专家能完全控制。",
        "focus": ["vue", "vite", "javascript", "frontend"],
        "domain": "前端框架",
    },
    "tj": {
        "name": "TJ Holowaychuk",
        "repo": "expressjs/express",
        "repos": ["expressjs/express", "tj/commander.js"],
        "github_login": "tj",
        "tagline": "Express/Koa 作者 — 极简主义，小而美",
        "philosophy": "最好的框架是不需要框架。给用户最小的核心，让他们自己组合。",
    ...
    "sindresorhus": {
        ...
        "repos": ["sindresorhus/got", "sindresorhus/execa", "sindresorhus/chalk"],
        "github_login": "sindresorhus",
        "tagline": "npm 之王 — 单一职责，模块化极致，TypeScript-first",
        "philosophy": "每个包只做一件事，把那件事做到极致。组合胜于继承，模块胜于框架。",
    ...
    "jaredpalmer": {
        ...
        "repos": ["jaredpalmer/formik", "vercel/turborepo"],
        "github_login": "jaredpalmer",
        "tagline": "Formik/Turborepo 作者 — DX 优先，工具链思维",
        "philosophy": "开发者体验是产品特性。如果用起来痛苦，就没人用，再强大也没用。",
        "focus": ["react", "typescript", "dx", "monorepo"],
        "domain": "开发工具",
    },
    "dan_abramov": {
        "name": "Dan Abramov",
        "repo": "facebook/react",
        "repos": ["facebook/react", "reduxjs/redux"],
        "github_login": "gaearon",
        "tagline": "Redux/React Hooks 作者 — 教育优先，每个 commit 都是教程",
        "philosophy": "理解为什么比知道怎么做更重要。好的API设计让错误用法变得困难。",
        "focus": ["react", "javascript", "open-source", "education"],
        "domain": "前端框架",
    },
    # ── AI / ML ───────────────────────────────────────────────────────────
    "karpathy": {
        ...
        "repos": ["karpathy/nanoGPT", "karpathy/micrograd", "karpathy/makemore", "karpathy/llm.c"],
        "github_login": "karpathy",
        "tagline": "前 OpenAI/Tesla AI 负责人 — 极简实现，教学即代码",
        "philosophy": "理解的最好方式是从零实现。代码行数越少，理解越深。300行能说清楚的，不用3000行。",
    ...
    "geohot": {
        ...
        "repos": ["tinygrad/tinygrad", "commaai/openpilot"],
        "github_login": "geohot",
        "tagline": "tinygrad 作者 — 极速迭代，删代码是主要工作",
        "philosophy": "最好的代码是不存在的代码。性能声明没有基准测试等于谎言。速度是护城河。",
        "focus": ["AI", "ML-framework", "systems", "python"],
        "domain": "AI 框架",
    },
    "fchollet": {
        "name": "François Chollet",
        "repo": "keras-team/keras",
        "repos": ["keras-team/keras", "google/ARC-AGI"],
        "github_login": "fchollet",
        "tagline": "Keras 作者 — API 设计即产品设计，AI 民主化",
        "philosophy": "API的清晰度比运行速度更重要。用户体验是功能，不是装饰。兼容性是对用户的承诺。",
    ...
    "rasbt": {
        ...
        "repos": ["rasbt/LLMs-from-scratch", "rasbt/machine-learning-book"],
        "github_login": "rasbt",
        "tagline": "《从零构建LLM》作者 — 章节驱动，读者反馈即时响应",
        "philosophy": "教育是产品，不是副产品。每行代码都应该是一个学习机会。错误必须即时修正。",
        "focus": ["AI", "LLM", "education", "python"],
        "domain": "AI 教育",
    },
    "lucidrains": {
        ...
        "repos": ["lucidrains/x-transformers", "lucidrains/vit-pytorch", "lucidrains/denoising-diffusion-pytorch"],
        "github_login": "lucidrains",
        "tagline": "ML 论文复现之王 — 论文→代码最短路径，变体库思维",
        "philosophy": "研究者需要的不是最好的实现，而是最快可用的实现。提供40个变体，让用户选择。",
        "focus": ["AI", "transformers", "pytorch", "research"],
        "domain": "AI 研究复现",
    },
    "simonw": {
        "name": "Simon Willison",
        "repo": "simonw/llm",
        "repos": ["simonw/llm", "simonw/datasette", "simonw/sqlite-utils"],
        "github_login": "simonw",
        "tagline": "Datasette/LLM CLI 作者 — 工具组合胜于单一全能工具",
        "philosophy": "每个工具做一件事，工具之间可以组合。Issue先于代码，博客先于功能，插件优于核心膨胀。",
        "focus": ["AI", "python", "cli", "sqlite", "tools"],
        "domain": "AI 工具",
    },
    "thomwolf": {
        "name": "Thomas Wolf",
        "repo": "huggingface/transformers",
        "repos": ["huggingface/transformers", "huggingface/diffusers", "huggingface/peft"],
        "github_login": "thomwolf",
        "tagline": "HuggingFace CTO — 开放 AI 生态，新论文即实现",
        "philosophy": "速度是生态位。新论文发布后48小时内有实现，统一API让用户无缝切换。社区是最好的团队。",
    ...
    "jph00": {
        "name": "Jeremy Howard",
        "repo": "fastai/fastai",
        "repos": ["fastai/fastai", "fastai/nbdev"],
        "github_login": "jph00",
        "tagline": "fast.ai 创始人 — notebook-first 开发，顶向下学习法",
        "philosophy": "notebook不是草稿，是source of truth。顶向下教学：先让代码跑起来，再解释原理。",
        "focus": ["AI", "fastai", "nbdev", "python", "education"],
        "domain": "AI 教育",
    },
}
...
def _gh_get(url: str, token: str | None = None) -> dict | list | None:
    ...
    headers = {
        ...
        "User-Agent": "ShrimpFlow-Workprint/1.0",
    }
    if token:
