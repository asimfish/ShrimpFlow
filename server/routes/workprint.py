...
把 ShrimpFlow 已挖掘的 BehaviorPattern + TeamWorkflow 导出为 SKILL.md 格式。
Workprint 是 ShrimpFlow 的输出层，不是独立工具。
"""
import json
import time
...
Generated by [ShrimpFlow](https://github.com/asimfish/ShrimpFlow) — every pattern below is backed by empirical behavioral evidence with Bayesian confidence scoring, not inferred from self-reports."""
...
def _footer() -> str:
    return (
        "---\n\n"
        "_Generated by [ShrimpFlow](https://github.com/asimfish/ShrimpFlow) Workprint export — "
...
def _render_learned_skill_md(your_name: str, insights: list[MentorInsight]) -> str:
    ...
    lines += [
        "---",
        "",
        f"_Generated by [ShrimpFlow](https://github.com/asimfish/ShrimpFlow) — "
        "Distill real behavior traces into executable AI skills._",
    ]
    return "\n".join(lines)
