...
const buildWorkprintMarkdown = () => {
  ...
  const lines = [
    '---',
    'name: workprint/me',
    `description: Behavioral skill distilled from ${patterns.length} ShrimpFlow demo patterns`,
    'version: 0.1.0-demo',
    'source: ShrimpFlow synthetic public demo snapshot',
    '---',
    '',
    '# Workprint: me',
    '',
    `> **${patterns.length}** active behavioral patterns distilled from ShrimpFlow synthetic demo traces.`,
    '',
    'This public preview demonstrates how ShrimpFlow turns behavior evidence into an executable Claude Code skill without exposing private traces.',
    '',
    '## Usage',
    '',
    '```',
  ...
  lines.push(
    ...
    '',
    '_Generated by ShrimpFlow Workprint export._',
  )
  return lines.join('\n')
}
...
const buildMentorSkillMarkdown = () => {
  ...
  lines.push('_Generated by ShrimpFlow Workprint mentor learning demo._')
  return lines.join('\n')
}
    ...
    <div class="max-w-5xl mx-auto w-full px-6 py-6 space-y-6">
      ...
      <div class="flex items-start justify-between">
        <div>
          ...
          <p class="text-sm text-gray-400">
            Distill your ShrimpFlow behavior patterns into an executable Claude ​Code skill
          </p>
        </div>
        <button
      ...
      <div v-if="preview" class="flex items-center gap-3">
        ...
        <p class="text-xs text-gray-500">
          将 ShrimpFlow 挖掘的 {{ preview.total_patterns }} 个 pattern 导出为 Claude ​Code 可读的行为技能文件
        </p>
      </div>
      ...
      <div class="border-t border-[#252535] pt-6">
        ...
        <div class="mb-4">
          ...
          <div v-if="showTokenInput" class="mt-2 flex items-center gap-2">
            ...
            />
            <a href="https://github.com/settings/tokens/new?scopes=public_repo&description=ShrimpFlow+Workprint"
              target="_blank"
      ...
      <div class="bg-[#12121a] border border-[#252535] rounded-xl p-5">
        ...
        <div class="space-y-3 text-sm text-gray-400">
          ...
          <div class="flex gap-3">
            ...
            <div>
              <div class="text-gray-300 mb-0.5">持续更新（每次 ShrimpFlow 挖到新 pattern 就重新导出）</div>
